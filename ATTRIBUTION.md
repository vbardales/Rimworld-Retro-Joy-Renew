...
Everything the mod contained that it actually used: 14 of its 21 defs and all ten of its textures.
The seven left behind are abstract bases it never inherited from — see below.
...
- The previous Workshop preview, replaced by an original preview generated with Codex (OpenAI).
...
style was generated by the maintainer. Its full-resolution source is retained at
`Art/ModIcon-source.png`; the distributed `About/ModIcon.png` is its 128 px derivative.
